...
enum {
    ...
    UI_SETTINGS_IMMERSIVE_Y = 192,
    UI_SETTINGS_IMMERSIVE_HEIGHT = 24,
    UI_SETTINGS_REDUCED_MOTION_Y = 218,
    UI_SETTINGS_REDUCED_MOTION_HEIGHT = 24,
    UI_SETTINGS_LIMIT_Y = 244,
    ...
    UI_SETTINGS_DEBUG_Y = 276,
    UI_SETTINGS_DEBUG_HEIGHT = 24,
    UI_SETTINGS_CLEAR_Y = 302,
    UI_SETTINGS_CLEAR_HEIGHT = 28,
    UI_SETTINGS_CONTACT_Y = 332,
    UI_SETTINGS_CONTACT_HEIGHT = 62,
    UI_SETTINGS_REPOSITORY_Y = 396,
    UI_SETTINGS_REPOSITORY_HEIGHT = 62,
    UI_SETTINGS_USAGE_NOTICE_Y = 460,
    UI_SETTINGS_USAGE_NOTICE_HEIGHT = 28,
    UI_SETTINGS_VERSION_Y = 490,
