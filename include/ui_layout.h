...
enum {
    ...
    UI_SETTINGS_CONTROL_COLOR_Y = 114,
    UI_SETTINGS_CONTROL_COLOR_HEIGHT = 24,
    UI_SETTINGS_DARK_THEME_Y = 140,
    UI_SETTINGS_DARK_THEME_HEIGHT = 24,
    UI_SETTINGS_LYRIC_ALIGNMENT_Y = 166,
    UI_SETTINGS_LYRIC_ALIGNMENT_HEIGHT = 24,
    UI_SETTINGS_LYRIC_TRANSLATION_Y = 192,
    UI_SETTINGS_LYRIC_TRANSLATION_HEIGHT = 24,
    UI_SETTINGS_IMMERSIVE_Y = 218,
    UI_SETTINGS_IMMERSIVE_HEIGHT = 24,
    UI_SETTINGS_REDUCED_MOTION_Y = 244,
    UI_SETTINGS_REDUCED_MOTION_HEIGHT = 24,
    UI_SETTINGS_LIMIT_Y = 270,
    ...
    UI_SETTINGS_DEBUG_Y = 302,
    UI_SETTINGS_DEBUG_HEIGHT = 24,
    UI_SETTINGS_CLEAR_Y = 328,
    UI_SETTINGS_CLEAR_HEIGHT = 28,
    UI_SETTINGS_CONTACT_Y = 358,
    UI_SETTINGS_CONTACT_HEIGHT = 62,
    UI_SETTINGS_REPOSITORY_Y = 422,
    UI_SETTINGS_REPOSITORY_HEIGHT = 62,
    UI_SETTINGS_USAGE_NOTICE_Y = 486,
    UI_SETTINGS_USAGE_NOTICE_HEIGHT = 28,
    UI_SETTINGS_VERSION_Y = 516,
